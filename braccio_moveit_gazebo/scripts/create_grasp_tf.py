...
if __name__ == '__main__':
    ...
    #     # hand_pose_world = vision_utils.transform_pose_vislab(initial_pose, "camera_depth_optical_frame", "mount")
    ...
    targetter.get_planning_infos()
    targetter.planning_pose_example()
    # targetter.set_joint(arm_target_pose)
